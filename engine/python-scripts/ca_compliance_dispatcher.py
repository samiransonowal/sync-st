...
4. Admin Bank Statement Reminder (Prompts Samiran to share official HDFC Bank Statement)
"""
...
ADMIN_EMAIL = "samiran@studiotunnel.com"
  ...
  <div class="card">
    ...
    <div class="content">
      ...
      <p style="font-size: 12px; color: #475569;">
        • The official HDFC Bank Statement PDF for <strong>{month_str}</strong> has been requested from Admin (<code>samiran@studiotunnel.com</code>) and will be forwarded under a separate email thread once downloaded from netbanking.
      </p>
    ...
    <div class="footer">
      Studio Tunnel Financial Comptroller &bull; samiran@studiotunnel.com
    </div>
  </div>
</body>
</html>
